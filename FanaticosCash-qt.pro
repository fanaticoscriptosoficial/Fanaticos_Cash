...
fName1 = "FanaticosCash-Qt"
macx:TARGET = "FanaticosCash-Qt"
VERSION = 3.0.0.1
QMAKE_TARGET_BUNDLE_PREFIX = co.FanaticosCash
...
macx: {
    ...
    ICON = src/qt/res/icons/fanaticoscash.icns
    TARGET = FanaticosCash-v1.0.0.1-qt
