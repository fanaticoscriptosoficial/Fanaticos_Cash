...
static const int SKIP_VALIDATION_HEIGHT = 0;
...
static const uint256 hashGenesisBlock("0x000004a3688fa1a54503ea75ed5c1c41660382a54401ff3ddea258e4cefe4a43"); //Bloco Gênesis MainNet- Francis
...
public:
    ...
    {
        // FanaticosCash: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // FanaticosCash: get transaction coin age
...
public:
    ...
    // FanaticosCash: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // FanaticosCash: two types of block: proof-of-work or proof-of-stake
    ...
    // FanaticosCash: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // FanaticosCash: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // FanaticosCash: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // FanaticosCash: block index flags
    enum
    {
