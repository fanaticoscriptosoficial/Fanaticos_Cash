...
// Copyright (c) 2013 The Fanaticoscash developers
...
CBlock* CreateNewBlock(CWallet* pwallet, bool fProofOfStake, int64_t* pFees)
{
    ...
    int64_t nFees = 0;
    {
        ...
        while (!vecPriority.empty())
        {
            ...
            if (!tx.ConnectInputs(txdb, mapInputs, mapTestPoolTmp, CDiskTxPos(1,1,1), pindexPrev, false, MANDATORY_SCRIPT_VERIFY_FLAGS)) 
                continue;
...
void StakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("FanaticosCash-miner");
