...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("FanaticosCash-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("FanaticosCash-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("FanaticosCash-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FanaticosCash " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed1.fanaticoscriptos.com", "seed1.fanaticoscriptos.com"}, //Nodes Fanáticos Cash - Francis
    {"seed2.fanaticoscriptos.com", "seed2.fanaticoscriptos.com"},
    {"seed3.fanaticoscriptos.com", "seed1.sperocoin.org"},
    //{"seed4.fanaticoscriptos.com", "seed4.fanaticoscriptos.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("FanaticosCash-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("FanaticosCash-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("FanaticosCash-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("FanaticosCash-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FanaticosCash is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("FanaticosCash-start");
