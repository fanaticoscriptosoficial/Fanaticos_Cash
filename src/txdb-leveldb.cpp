...
bool CTxDB::LoadBlockIndex()
{
    ...
    while (iterator->Valid())
    {
        ...
        // Fanaticoscash: build setStakeSeen
    ...
    BOOST_FOREACH(const PAIRTYPE(int, CBlockIndex*)& item, vSortedByHeight)
    {
        ...
        // Fanaticoscash: calculate stake modifier checksum
        //pindex->nStakeModifierChecksum = GetStakeModifierChecksum(pindex); //29/08/2016
        //if (!CheckStakeModifierCheckpoints(pindex->nHeight, pindex->nStakeModifierChecksum)) //29/08/2016
        //    return error("CTxDB::LoadBlockIndex() : Failed stake modifier checkpoint height=%d, modifier=0x%016"PRIx64, pindex->nHeight, pindex->nStakeModifier); //29/08/2016
    }
    ...
    // Fanaticoscash: load hashSyncCheckpoint
