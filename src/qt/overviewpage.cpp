...
{
   WalletModel::EncryptionStatus status = model->getEncryptionStatus();
   if (status == WalletModel::Locked) ui->unlockWalletButton->setText(QString("Unlock your FanaticosCash"));
   else ui->unlockWalletButton->setText(QString("Lock your FanaticosCash"));
}